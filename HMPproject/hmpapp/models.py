...
class UserData(models.Model):
    ...
    role          = models.CharField(max_length=100, default="new")

    def __str__(self):
        return f"{self.u_id} - {self.role} - {self.user_name} - {self.pub_date} - {self.pub_time}"
...
class RequestData(models.Model):
    ...
    user_name     = models.CharField(max_length=255, default="")
    reqtitle      = models.CharField(max_length=255, default="")
    req_details   = models.CharField(max_length=5000, default="")
    pub_date      = models.DateField()
    pub_time      = models.CharField(max_length=20, default="")
    ...
    def __str__(self):
        return f"{self.req_id} {self.reqtitle} - {self.user_name} - {self.pub_date} - {self.pub_time} {self.status}"
...
class ProjectData(models.Model):
    ...
    user_name = models.CharField(max_length=255, default="")
    projtitle = models.CharField(max_length=255, default="")
    proj_details = models.CharField(max_length=10000, default="")

    pub_date = models.DateField()
    pub_time = models.CharField(max_length=20, default="")
    status = models.CharField(max_length=100, default="new")
    proj_req_list = models.CharField(max_length=10000, default="[]")

    def __str__(self):
        return f"{self.proj_id} {self.projtitle} - {self.user_name} - {self.pub_date} - {self.pub_time} - {self.status}"
